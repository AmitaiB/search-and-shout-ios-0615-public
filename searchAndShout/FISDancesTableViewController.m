//
//  FISDancesTableViewController.m
//  searchAndShout
//
...
@interface FISDancesTableViewController ()

@end

@implementation FISDancesTableViewController
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [self.store.dances count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    FISDanceMove *move = self.store.dances[indexPath.row];
